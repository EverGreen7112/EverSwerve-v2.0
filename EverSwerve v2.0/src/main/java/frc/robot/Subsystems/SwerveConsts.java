...
public interface SwerveConsts {
        ...
        // motor controllers
        public static final EverSparkMax TL_DRIVE_MOTOR = new EverSparkMax(18),
                        ...
                        DR_STEER_MOTOR = new EverSparkMax(27);
        ...
        public static final EverPIDController HEADING_ANGLE_CONTROLLER = null,
                        X_CONTROLLER = null,
                        Y_CONTROLLER = null;
        // chassis encoders
        public static final EverAbsEncoder TL_ABS_ENCODER = new EverCANCoder(4),
                        TR_ABS_ENCODER = new EverCANCoder(5),
                        DL_ABS_ENCODER = new EverCANCoder(0),
                        DR_ABS_ENCODER = new EverCANCoder(1);
        ...
        public static final double ROBOT_BOUNDING_CIRCLE_PERIMETER = Math.PI * Math.sqrt(
                        FRONT_WHEEL_DIST_METERS * FRONT_WHEEL_DIST_METERS
                                        + SIDE_WHEEL_DIST_METERS * SIDE_WHEEL_DIST_METERS);
        ...
        // swerve vectors
        public static final Vector2d TR = new Vector2d((FRONT_WHEEL_DIST_METERS / 2),
        ...
        public static final Vector2d[] physicalMoudulesVector = { TL, TR, DL, DR };// array of vectors from robot center
                                                                                   // to swerves module

        public static final SwerveModule[] SWERVE_MODULES = {
                        new SwerveModule(TL_VELOCITY_CONTROLLER, TL_DRIVE_MOTOR,
                                        new EverSparkInternalEncoder(TL_DRIVE_MOTOR), TL_ANGLE_CONTROLLER,
                                        TL_STEER_MOTOR, new EverSparkInternalEncoder(TL_STEER_MOTOR), ABS_ENCODERS[0]),
                        new SwerveModule(TR_VELOCITY_CONTROLLER, TR_DRIVE_MOTOR,
                                        new EverSparkInternalEncoder(TR_DRIVE_MOTOR), TR_ANGLE_CONTROLLER,
                                        TR_STEER_MOTOR, new EverSparkInternalEncoder(TR_STEER_MOTOR), ABS_ENCODERS[1]),
                        new SwerveModule(DL_VELOCITY_CONTROLLER, DL_DRIVE_MOTOR,
                                        new EverSparkInternalEncoder(DL_DRIVE_MOTOR), DL_ANGLE_CONTROLLER,
                                        DL_STEER_MOTOR, new EverSparkInternalEncoder(DL_STEER_MOTOR), ABS_ENCODERS[2]),
                        new SwerveModule(DR_VELOCITY_CONTROLLER, DR_DRIVE_MOTOR,
                                        new EverSparkInternalEncoder(DR_DRIVE_MOTOR), DR_ANGLE_CONTROLLER,
                                        DR_STEER_MOTOR, new EverSparkInternalEncoder(DR_STEER_MOTOR), ABS_ENCODERS[3])
        };
