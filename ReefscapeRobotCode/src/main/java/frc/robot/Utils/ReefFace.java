...
public class ReefFace {
    ...
    public static final ReefFace[] BLUE_REEF = {
        new ReefFace(3.66, 4.03, 0  , 0,0,0,0,0,0),
        new ReefFace(4.07, 3.31, 60 , 0,0,0,0,0,0),
        new ReefFace(4.90, 3.31, 120, 0,0,0,0,0,0),
        new ReefFace(5.32, 4.03, 180, 0,0,0,0,0,0),
        new ReefFace(4.90, 4.75, 240, 0,0,0,0,0,0),
        new ReefFace(4.07, 4.75, 300, 0,0,0,0,0,0)

    };

    public static final ReefFace[] RED_REEF = {
        new ReefFace(12.23, 4.03, 0,    0,0,0,0,0,0),
        new ReefFace(12.64, 3.31, 60,   0,0,0,0,0,0),
        new ReefFace(13.47, 3.31, 120,  0,0,0,0,0,0),
        new ReefFace(13.89, 4.03, 180,  0,0,0,0,0,0),
        new ReefFace(13.47, 4.75, 240,  0,0,0,0,0,0),
        new ReefFace(12.64, 4.75, 300,  0,0,0,0,0,0)
